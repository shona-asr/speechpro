...
import { ArrowLeft, ExternalLink, Mic, GitBranch, Sparkles, Languages, Zap } from "lucide-react";
      ...
      <main className="flex-1 bg-gray-50">
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-primary/10 to-white">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">About SpeechGenius</h1>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8">
              Powered by state-of-the-art AI models including 
              <span className="font-semibold"> Whisper Large Shona</span>, 
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="md:w-1/2">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Whisper Large Shona</h2>
                <p className="text-gray-700 mb-6">
                  The Whisper Large Shona model represents a significant advancement in speech recognition technology, 
              ...
              <div className="md:w-1/2">
                ...
                <div className="mt-8 space-y-4">
                  <h3 className="text-lg font-semibold text-gray-900">Integration in SpeechGenius</h3>
                  <p className="text-gray-700">
                    The Whisper Large Shona model powers many of our platform's key features, particularly 
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm font-medium text-gray-800">Google Cloud Speech</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm font-medium text-gray-800">OpenAI Whisper</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm font-medium text-gray-800">Google Translate</span>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-lg font-bold text-white">SpeechGenius</span>
          </div>
